// Comprobaciones de navegador (File API y Filereader)
...
//Configuración de los botones que vamos a emplear

        reader.onload = (function (theFile) {
            return function (e) {
                let videoDiv = document.getElementsByClassName('video-input');
